...
//		drawMap(g2, "", 		collisionMap);
	...
	public SimpleEntry<Rectangle, Integer> haveCollisionWithLand(Rectangle rect) {
...
//			object.setPosX(object.getPosX() + AnimatedObject.TRANSPORT_SPEED * Object.LEFT_DIR);
//			object.setOnTransportLeft(false);
//			if(object.getSpeedX() == 0 && object.isOnTransportLeft()) {
//				object.setSpeedX(object.getSpeedX() + AnimatedObject.TRANSPORT_SPEED * Object.LEFT_DIR);
//				object.setOnTransportLeft(false);
//			} else object.setSpeedX(object.getSpeedX() - AnimatedObject.TRANSPORT_SPEED * Object.LEFT_DIR);
//		}
...
//		}
		...
		return new SimpleEntry<Rectangle, Integer>(collisionRect, tile);
	}
